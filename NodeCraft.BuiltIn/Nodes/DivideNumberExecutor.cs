...
{
    public class DivideNumberExecutor : IFlowNodeExecutor
    {
        public const string FlowNodeTypeKey = "nodecraft.builtin.divide-number";
            ...
            CancellationToken cancellationToken)
        {
            ...
            {
                [BuiltInPortIds.Output] = Math.Abs(right) < double.Epsilon ? 0d : left / right,
            };
